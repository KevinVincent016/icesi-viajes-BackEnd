...
public class TipoIdentificacionServiceImpl implements TipoIdentificacionService{
    ...
    @Override
    public List<TipoIdentificacionDTO> consultarTipoIdentificacionPorEstado(String estado) {
        return tipoIdentificacionRepository.consultarTipoIdentificacionPorEstado(estado);
    }

    @Override
    public List<TipoIdentificacionDTO> consultarTipoIdentificacionPorCodigoYEstado(String codigo, String estado) {
        return tipoIdentificacionRepository.consultarTipoIdentificacionPorCodigoYEstado(codigo, estado);
    }
}
